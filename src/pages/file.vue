<template>
  ...
  <div class="w-872px mx-auto mt-3" style="position: relative">
    <div
      ...
      <div class="py-3 mt-5 border-b flex justify-between text-13px text-hex-999">
        <span>访问量</span>
        <span>12423</span>
      </div>
      ...
      <div class="text-center mt-5"><el-button type="primary" plain size="large">下载</el-button></div>
    </div>
    <div class="border rounded mt-3 bg-white">
      <div
        class="h-1020px"
        style="background: url(/images/427f71cac5da50e2524d7ff8.png); background-size: 100%">
      </div>
      <div
        class="h-1020px"
        style="background: url(/images/427f71cac5da50e2524d7ff8.png); background-size: 100%">
    ...
    <div class="bg-white mt-4 text-left p-4 px-6">
      <div class="border-b pb-3">全部4条评论</div>
      <div class="mt-5">
        <el-input
          v-model="textarea"
        ...
        />
        <div class="mt-3 text-right"> <el-button type="primary">发表评论</el-button></div>
      </div>
      <div class="mt-7 border-t">
        <div v-for="item in commentList" class="border-b py-4 text-13px" :key=item>
          <div
            style="background-color: rgb(192,211,251); border-radius: 12px; float: left" 
